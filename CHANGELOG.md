...
- Upgraded `bevy` to `0.19`.
- Updated the example to Bevy `0.19`.

### Fixed

- Feature gate compression helpers behind `writer` feature.
...
[Unreleased]: https://github.com/ldubos/bevy-histrion-packer/compare/v0.9.0...HEAD
[0.9.0]: https://github.com/ldubos/bevy-histrion-packer/compare/v0.8.0...v0.9.0
[0.8.0]: https://github.com/ldubos/bevy-histrion-packer/compare/v0.7.1...v0.8.0
